...
then
  ...
  then
    sudo ./tools/sunxitools/bin2fex ./_temp/bootfs/script.bin ./_temp/bootfs/script.ini
  ...
  then
    sudo ./tools/sunxitools/fex2bin ./_temp/bootfs/script.ini ./_temp/bootfs/script.bin
