...
then
  ...
  then
    sudo ./tools/sunxi-tools/bin2fex ./_temp/bootfs/script.bin ./_temp/bootfs/script.ini
  ...
  then
    sudo ./tools/sunxi-tools/fex2bin ./_temp/bootfs/script.ini ./_temp/bootfs/script.bin
